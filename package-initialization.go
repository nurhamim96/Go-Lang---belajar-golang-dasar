...
import (
	//_"belajar-golang-dasar/database" //Menggunakan blank identifier untuk import yang tidak pakai
...
- Secara default, Go-Lang komplain ketika ada package yang di import namun tidak digunakan
